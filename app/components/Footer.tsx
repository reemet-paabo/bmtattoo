        ...
        <footer className="bg-zinc-900 text-white">
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/** Contact Infot Section */}
                    <div>
                        <h3 className="text-xl font-bold mb-4">Contact</h3>
                        <ul className="space-y-2 text-gray-300">
                            <li>📍 123 Tattoo Street, Tallinn</li>
                            <li>📞 +372 1234 5678</li>
                            <li>✉️ info@bmtattoo.ee</li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-300">
                            ...
                            <li>Sunday: Closed in honor of Jesus</li>
                        </ul>
                    </div>
                    {/** Quick Links & Social */}
                    <div>
                ...
                <div className="border-t border-zinc-800 mt-8 pt-8 text-center text-gray-400">
                    <p>&copy; {new Date().getFullYear()} BM Tattoo Studio. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
